...
export default function Header() {
  ...
  return (
    <nav >
      <div className="relative top-0 left-0 right-0 z-50 items-center py-5 px-5 flex flex-col gap-3 max-w-md mx-auto">
        <div className="justify-between flex w-full">
          <Link href="/" className="flex items-center gap-2 ">
            <Image src="/icon.svg" alt="Jeda" width={32} height={32}  />
            <h1 className="text-2xl font-bold text-foreground font-fredoka hidden md:flex ">
              Jeda
            </h1>
          </Link>
